...
class RestaurantOrderManagement:
    def __init__(self , root):
        ...
        ttk.Label(frame , text="Restaurant Management System" , font=("Arial" , 20 , "bold")).grid(row=0 , columnspan=3 , padx=10 , pady=10)
        ...
        order_button = ttk.Button(frame , text="Place Order" , text="Place Order" , command=self.place_order)
